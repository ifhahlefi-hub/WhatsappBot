...
const PATTERNS = [
  ...
  },
  {
    ...
    responses: [
      ...
      "meeting masuk ke jam kerjaan yg seharusnya bisa dipersingkat, ini agak ngaco sih",
      "meeting di tengah-tengah kerja? ini jadwalnya rada nyeleneh, ya allah",
  ...
  },
  {
    ...
    responses: ["oke, bilang aja kalo butuh sesuatu", "noted", "sip sayang"],
  },
  {
    id: "decline",
    keywords: ["gak mau", "ga mau", "nggak", "engga", "ogah", "males", "malas"],
    responses: ["haha ok gpp, no pressure", "kalo udh siap aja", "fair enough"],
  },
  {
    id: "doing",
    keywords: [
